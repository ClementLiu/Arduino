...
void setup() {
  ...
  for(int i=0; i <= 10; i++){
      printer.printBarcode("111111111", CODE93);
      printer.printBarcode("222222222", CODE93);
      printer.printBarcode("333333333", CODE93);  
      //printer.printBarcode("NEWYORK", CODE93);
      //printer.printBarcode("BUILDING", CODE93);
      //printer.printBarcode("CITY", CODE93);
  }
